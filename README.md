...
В таске не было описания требований по оптимизации, поэтому из подобных решений я ввёл лишь кэширование через редиску. Однако конечно, т.к. тот же 0x66357dCaCe80431aee0A7507e2E361B7e2402370 парсить с 3летней давности до текущего момента - это очень долго, то было бы славно подкрутить полноценную базу данных, где хранились бы эти ивенты и информация о том, какие блоки уже были получены. Но это уже другая история :)
