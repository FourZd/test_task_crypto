...
{<img width="735" height="334" alt="1494914961183622594" src="https://github.com/user-attachments/assets/acd27730-1ba8-4af7-bfe7-bcfce8a5eb40" />
## Возникшие проблемы, которые решать как будто бы слишком проблематично внутри простого тестового задания.
...
Однако я внедрил логи, которые позволяют понять, что код работает. Можно также выгрузить в файл.
```
blockchain-api    | 2025-11-27 21:01:28,710 - blockchain_api - INFO - ✓ Completed fetching 11965 chunks total: 8721 with logs, 3244 empty, 0 errors
blockchain-api    | 2025-11-27 21:01:31,706 - blockchain_api - INFO - Fetched 595827 logs total, 0 chunks failed
blockchain-api    | 2025-11-27 21:01:31,706 - blockchain_api - INFO - Decoded 595827 events successfully
blockchain-api    | INFO:     151.101.128.223:28514 - "POST /api/blockchain/events HTTP/1.1" 200 OK
```
